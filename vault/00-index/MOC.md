...
- `docs/11-gtm-strategy.md` — GTM-стратегия к первому $1M (Поток-2), 10 этапов + система оценки инициатив + адверсариальный аудит; собрана мульти-агентным комитетом, маркировка факт/оценка/гипотеза.
