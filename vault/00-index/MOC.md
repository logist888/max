...
- `docs/16-partner-flows-tz.md` — ТЗ по путям семьи и партнёра для разработчиков (12.09.2026): шаги, экраны, запросы, правила, состояния, приёмка. Интерактивная карта — `docs/html/partner-flows.html`, прототип кабинета партнёра — `docs/html/partner-cabinet.html`. PDF: [[../40-reports/2026-09-12-partnerskaya-set-tz-puti.pdf]].
