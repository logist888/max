...
page(
    ...
    *bullets([
        ...
        "Пилот: 10 знакомых партнёров на первой неделе. Ориентир 30–50 подключений за месяц взят из стратегического PDF и командой не обсуждался; дополнительные расходы возможны, лимит не назначен. Амбиция 10 000 партнёров сохранена как стратегическая рамка, не как план месяца.",
    ]),
    Spacer(1, 6),
    P("Что не решено", "h2"),
    *bullets([
