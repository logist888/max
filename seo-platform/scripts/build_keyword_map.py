...
DISP = {
    ...
    # --- P3 GATED: нет предметов ЕГЭ по направлениям ---
    "c10_s_obschestvoznaniem":   ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ по направлениям в БД"),
    "c11_s_istoriej":            ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
    "c12_s_biologiej":           ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
    "c13_s_informatikoj":        ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
    "c14_s_himiej":              ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
    "c15_s_fizikoj":             ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
    "c16_s_geografiej":          ("Gated — нужны данные", "—", "P3", "Нет предметов ЕГЭ в БД"),
